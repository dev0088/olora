            ...
            <template slot="action-slot" slot-scope="props">
                <div class="list-icons">
                    <dropdown menu-right>
                        ...
                        <button class="dropdown-item" type="button" @click="resetClicks(props.rowData)"><i class="fal fa-undo"></i> Reset Clicks</button>
...
export default {
    ...
    methods: {
        ...
        resetClicks(link) {
            this.$confirm('This will reset ALL metrics for this link, are you sure?', 'Reset Clicks', {
                confirmButtonText: "Yes I'm sure",
            }).then(() => {

                axios.put('links/reset/' + link.id)
                .then(response => {
